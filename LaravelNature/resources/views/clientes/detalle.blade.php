...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Detalles de Cliente</div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $personaData[0]['TIP_CLIENTE'] }}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="NOM_CLIENTE">NOMBRE</label>
                            <input type="text" value="{{ $personaData[0]['NOM_CLIENTE'] }}" class="form-control" readonly>
                        </div>
